...
public abstract class BaseDAOImpl<T extends BaseDTO> implements BaseDAOInt<T> {
	...
	public T findByUniqueKey(String attribute, Object val, UserContext userContext) {
		...
		System.out.println(val + " Inside basedaoimpl............");
		...
		if (userContext != null && !isZeroNumber(userContext.getOrgId())) {
			System.out.println("Inside basedaoimplFindbyUniqueKey");
			Predicate conditionGrp = builder.equal(qRoot.get("org_id"), userContext.getOrgId());
	...
	protected TypedQuery<T> createCriteria(T dto, UserContext userContext) {
		...
		System.out.println("Inside BaseDaoImpl createCriteria() run");
		...
		System.out.println("Inside basedaoimpl createCriteria() isgroup skipped......");
		cq.where(whereClause.toArray(new Predicate[whereClause.size()]));

		List<Order> orderBys = getOrderByClause(dto, builder, qRoot);

		System.out.println("Inside Basedaoimpl createCriteria() after getOrder By clause........");
		cq.orderBy(orderBys.toArray(new Order[orderBys.size()]));

		System.out.println("Inside Basedaoimpl createCriteria() After order by clause.......");
		TypedQuery<T> query = entityManager.createQuery(cq);
		System.out.println("Inside Basedaoimpl createCriteria() end here......");
		return query;
	...
	public List search(T dto, int pageNo, int pageSize, UserContext userContext) {
		System.out.println("Inside BaseDaoimpl search run");

		// System.out.println("Base DAO dto :: " + dto);
		// System.out.println(userContext);
		TypedQuery<T> query = createCriteria(dto, userContext);

		System.out.println("Inside basedaoimpl PAGENO = " + pageNo + " PAGESIZE = " + pageSize);
		if (pageSize > 0) {
	...
	public long add(T dto, UserContext userContext) {
		...
		System.out.println("Inside basedaoimpl Dto start");
		System.out.println("Inside basedaoimpl........ " + dto);
		System.out.println("Inside basedaoimpl before calling persist method......");
	...
	public void update(T dto, UserContext userContext) {
		...
		populate(dto, userContext);
		System.out.println("Inside basedaoimpl update.......");
	...
	protected List<Order> getOrderByClause(T dto, CriteriaBuilder builder, Root<T> qRoot) {
		...
		System.out.println("Inside basedaoimpl getOrderByClause()...........");
		...
		map.forEach((key, value) -> {
			if (value.equals("asc")) {
				System.out.println("Inside basedaoimpl getOrderByClause() in if value equals asc");
