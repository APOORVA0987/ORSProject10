...
public class EmailServiceImpl {
	...
	public void send(EmailDTO dto, UserContext ctx) {
		System.out.println("Inside Emailserviceimpl Send()........");
		// Get message from database if message code is not null
		if (dto.getMessageCode() != null) {
			System.out.println(dto.getMessageCode() + " msg code Inside Emailserviceimpl");
			MessageDTO messageDTO = messageService.findByCode(dto.getMessageCode(), ctx);
			System.out.println(dto.getMessageCode() + "Inside Emailserviceimpl");
			...
			System.out.println(dto.getMessageParams() + "MSG PARAM Inside Emailserviceimpl");
			System.out.println(
					messageDTO.getSubject(dto.getMessageParams()) + "68 line Inside Emailserviceimpl...........");
			dto.setSubject(messageDTO.getSubject(dto.getMessageParams()));

			System.out.println(dto.getSubject() + "Subject Inside Emailserviceimpl");
			dto.setBody(messageDTO.getBody(dto.getMessageParams()));
			System.out.println(dto.getBody() + "Body Inside Emailserviceimpl");

			dto.setIsHTML("Y".equals(messageDTO.getHtml()));
			System.out.println(dto.getIsHTML() + "HTML Inside Emailserviceimpl");

		}

		System.out.println(dto + "DTO Inside Emailserviceimpl");
		...
		new Thread(new Runnable() {
			...
			public void run() {
				System.out.println("Inside Emailserviceimpl run ");
