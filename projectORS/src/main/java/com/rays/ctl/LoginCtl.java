...
public class LoginCtl extends BaseCtl<UserForm, UserDTO, UserServiceInt> {
	...
	public ORSResponse get(@PathVariable String loginId) {
		...
		System.out.println("Inside LoginCtl User " + dto);
		if (dto != null) {
	...
	public ORSResponse login(@RequestBody @Valid LoginForm form, BindingResult bindingResult, HttpSession session,
		...
		if (dto == null) {
			...
			System.out.println("Inside LoginCtl Before calling userDetail authenticate");
	...
	public ORSResponse forgotPassword(@PathVariable String login, HttpServletRequest request) {
		System.out.println("Inside LoginCtl Forget password get run " + login);
	...
	public ORSResponse signUp(@RequestBody @Valid UserRegistrationForm form, BindingResult bindingResult) {
		...
		System.out.println(form.getDob() + "Inside LoginCtl SignUp()..........");

		dto.setPhone(form.getPhone());

		System.out.println(dto.getPhone() + "Inside LoginCtl SignUp()......");

		dto.setPassword(form.getPassword());

		System.out.println(dto.getPassword() + "Inside LoginCtl SignUp()..........");

		dto.setStatus("Inactive");

		System.out.println(form.getPhone() + "Inside LoginCtl SignUp()..............");

		dto.setAlternateMobile(form.getAlternateMobile());

		System.out.println(dto.getAlternateMobile() + "Inside LoginCtl SignUp()...............");
	...
	public ORSResponse uploadPic(@PathVariable Long userId, @RequestParam("file") MultipartFile file,
		...
		System.out.println("Inside LoginCtl uploadpic()");
		System.out.println("Inside LoginCtl uploadpic() User Id.............." + userId);
		...
		System.out.println(doc.getDescription() + "Inside LoginCtl uploadpic() description");

		doc.setPath(req.getServletPath());
		System.out.println(doc.getPath() + "Inside LoginCtl uploadpic() path");
		doc.setUserId(userId);
		System.out.println(doc.getUserId() + "Inside LoginCtl uploadpic() USer id.......");

		if (userDTO.getImageId() != null && userDTO.getImageId() > 0) {
			doc.setId(userDTO.getImageId());
		}
		System.out.println("Inside LoginCtl uploadpic() before calling save");
		Long imageId = attachmentService.save(doc, userContext);
		System.out.println("Inside LoginCtl uploadpic() after save");
		// Update new image id
		if (userDTO.getImageId() == null || userDTO.getImageId() == 0) {
