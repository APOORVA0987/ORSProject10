...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.intercept = function (req, next) {
        ...
        console.log(req.headers.get("Authorization") + " <<<--------------in Auth------------------->>>");
...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.isLogout = function () {
        var JSESSIONID = localStorage.getItem('token');
...
module.exports = __webpack_require__(/*! D:\Project10_UI\ORSProject10-UI\src\main.ts */"./src/main.ts");
